...
export default function Home() {
    ...
    const features = [
        {
            ...
            description:
                "AI automatically organizes your emails into intuitive categories like Work, Personal, Finance, and more, helping you focus on what matters.",
            icon: "folder",
        },
        {
            ...
            description:
                "Never miss important emails again. Our AI analyzes content and automatically flags urgent messages that need your immediate attention.",
            icon: "flag",
        },
        {
            ...
            description:
                "End-to-end encryption keeps your emails safe. We never scan your content for advertising - your data remains private and protected.",
            icon: "shield",
        },
        {
            ...
            description:
                "Works with your existing Gmail account. No need to change email addresses or migrate data - just connect and start experiencing smarter email.",
            icon: "mail",
        },
    ];
    ...
    const targetAudience = [
        ...
        },
        {
            title: "Team leaders",
            description:
                "Efficiently manage work communications with smart filters and categorization.",
            icon: "group",
        },
        {
        ...
        },
        {
            ...
            description:
                "Take your Gmail experience to the next level with AI-powered organization.",
            icon: "sparkles",
        },
    ];
                ...
                >
                    <Column maxWidth="s" horizontal="center" gap="l">
                        ...
                        <Text
                            ...
                            wrap="balance"
                        >
                            Mailbuddy organizes your Gmail with smart AI categories and priority
                            management, making email simple and efficient
                        </Text>
                    ...
                    <Row fillWidth horizontal="center" paddingTop="l" paddingLeft="l">
                        <Background position="absolute" top="0" mask={{ x: 25, y: 0, radius: 100 }}>
                            <SmartImage
                                alt="Email app background"
                                sizes="(max-width: 1024px) 100vw, 90vw"
                                aspectRatio="16/9"
                                radius="xl"
                                src="/images/landing/fantasy-background-1.jpg"
                            />
                        </Background>
                        <Column maxWidth="l">
                            <Column height={4} hide="m" />
                            <Background
                                mask={{ x: 50, y: 25, radius: 250 }}
                                style={{
                                    transform:
                                        "skewX(24deg) skewY(-7deg) scaleY(0.85) translateX(0)",
                                }}
                                minWidth={56}
                            >
                                <SmartImage
                                    alt="Email organization demo"
                    ...
                    <Column fillWidth horizontal="center" gap="40">
                        <Column maxWidth={32} gap="20">
                            ...
                            <Text
                                ...
                                marginBottom="l"
                            >
                                Stop drowning in your inbox. Let AI help you focus on what truly
                                matters.
                            </Text>
                        </Column>
                        ...
                        <Row gap="24" maxWidth="l" mobileDirection="column">
                            <Column fillWidth gap="8">
                                ...
                                <Column gap="8" padding="24">
                                    ...
                                    <Text onBackground="neutral-weak" wrap="balance">
                                        Separate work emails from personal ones. Keep track of
                            ...
                            <Column fillWidth gap="8">
                                ...
                                <Column gap="8" padding="24">
                                    ...
                                    <Text onBackground="neutral-weak" wrap="balance">
                                        Our AI identifies urgent emails that need immediate
                                        attention, letting you focus on what matters most right now.
                                    </Text>
                                </Column>
                            </Column>
                        </Row>
                                    ...
                                    <form onSubmit={handleWishlistSubmit} style={{ width: "100%" }}>
                                        <Column gap="16" fillWidth horizontal="center">
                                            <Badge
                                                ...
                                                align="center"
                                            >
                                                <Text weight="strong" marginRight="4">
                                            ...
                                            <Column horizontal="center" gap="16" maxWidth={24}>
                                                ...
                                                >
                                                    ...
                                                    and get early access to our premium tiers.
                                                </Text>
                                            </Column>
                                            <Background
                                                mask={{ x: 50, y: 0, radius: 50 }}
