    ...
    background="overlay">
      ...
      >
          ...
          <Column gap="12" fillWidth paddingY="48">
            ...
            {error && (
              <Text variant="body-default-s" align="center" style={{ color: 'var(--color-danger-weak)' }}>
          ...
          {error ? (
            <Row gap="8">
              <Button
                ...
                prefixIcon={["no_gmail_account", "invalid_credentials"].includes(errorType) ? "settings" : "arrowLeft"}
                weight="default"
              >
                {errorContent?.buttonText}
              </Button>
              
              {onReset && errorType !== "no_gmail_account" && errorType !== "invalid_credentials" && (
                <Button
                  variant="secondary"
