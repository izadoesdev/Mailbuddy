...
export function ContactDetail({ contact, onClose, onViewEmails }: ContactDetailProps) {
  ...
  const sortedCategories = Object.entries(contact.categories)
    .sort(([, countA], [, countB]) => countB - countA);
    
  // Sort priorities by email count
  const sortedPriorities = Object.entries(contact.priorities)
    .sort(([, countA], [, countB]) => countB - countA);
          ...
          <Column padding="24" gap="24" fill overflowY="auto">
            ...
            <Row gap="16" vertical="center" wrap>
              ...
              <Column gap="4">
                ...
                <Text variant="body-default-m" onBackground="neutral-weak">{contact.email}</Text>
            ...
            <Column gap="16">
              ...
              <Row wrap gap="24">
                ...
                <Column gap="4" minWidth={240}>
                  <Text variant="label-default-s" onBackground="neutral-weak">LAST CONTACT</Text>
                ...
                {/* Frequency */}
                <Column gap="4" minWidth={240}>
                  <Text variant="label-default-s" onBackground="neutral-weak">EMAIL FREQUENCY</Text>
                  <Text variant="body-strong-m">
                    {contact.emailCount > 10 ? 'Frequent' : 
                    contact.emailCount > 5 ? 'Regular' : 'Occasional'}
                  </Text>
                </Column>
              </Row>
            </Column>
                ...
                <Row wrap gap="12">
                  {sortedPriorities.map(([priority, count]) => (
                    <Tag
                      ...
                      variant={PRIORITY_COLORS[priority as keyof typeof PRIORITY_COLORS] || "neutral"}
                    />
                  ))}
                </Row>
              </Column>
