...
export default function SecuritySettings({ user }: SecuritySettingsProps) {
  ...
  const handleDisable2FA = async () => {
    ...
    try {
      ...
      addToast({
        variant: "danger",
        message: "Failed to disable two-factor authentication. Please check your password and try again.",
      });
    } finally {
      setIsLoading(false);
    }
      ...
      >
        ...
        {twoFactorStep === "backup" && twoFactorData.backupCodes && (
          <Column gap="16">
            ...
            <Text>
              If you lose access to your authentication app, you can use one of these backup
