...
export default function AIPage() {
    ...
    const tabOptions = [
        ...
        { value: "search", label: "Search Results", disabled: similarEmails.length === 0 },
        {
            value: "ai_insights",
            label: "AI Insights",
            disabled: getProcessedEmailsArray().length === 0,
        },
    ];
    ...
    return (
        <Column maxWidth="xl" paddingY="24" paddingX="16" gap="32" style={{ margin: "0 auto" }}>
            <Row horizontal="space-between" vertical="center" paddingBottom="16">
                <Heading variant="display-default-l" as="h1">
                    AI Email Assistant
                </Heading>
            </Row>
            ...
            <Card fill padding="24" radius="xl">
                <Column gap="16">
                    <Heading variant="heading-strong-m" as="h2">
                        Search Similar Emails
                    </Heading>
                    <Text variant="body-default-m">
                        Use AI to find semantically similar emails in your inbox
                    </Text>
            ...
            <Card fill padding="0" radius="xl" border="neutral-alpha-weak">
                    ...
                    <Column fill>
                        ...
                        >
                            <Text variant="heading-strong-s">
                                {loading ? "Loading emails..." : `Inbox (${totalCount})`}
                            </Text>
                            ...
                            <Row gap="8">
                                ...
                                />
                                <Text variant="label-default-s" padding="8">
                                    Page {page}
                                </Text>
                                <Button
                                    size="s"
                        ...
                        {loading ? (
                            <Column center paddingY="64">
                                <Spinner size="m" />
                                <Text variant="body-default-m" marginTop="16">
                                    Loading emails...
                                </Text>
                            </Column>
                        ) : emails.length > 0 ? (
                            <Column fill>
                                {emails.map((email, index) => {
                                    ...
                                    const hasAiMetadata =
                                        email.aiMetadata !== null && email.aiMetadata !== undefined;
                                    const aiCategory =
                                        hasAiMetadata && email.aiMetadata
                                    ...
                                    const priorityColor = aiPriority
                                        ? getPriorityColor(aiPriority)
                                        : undefined;
                ...
                {activeTab === "search" && similarEmails.length > 0 && (
                    <Column fill>
                        <Row padding="16" vertical="center">
                            <Text variant="heading-strong-s">
                                Search Results ({similarEmails.length})
                            </Text>
                        </Row>
                ...
                {activeTab === "ai_insights" && (
                    <Column fill>
                        <Row padding="16" vertical="center">
                            <Text variant="heading-strong-s">
                                AI Analyzed Emails ({getProcessedEmailsArray().length})
                            </Text>
                        </Row>
                                ...
                                {getProcessedEmailsArray().map((processedEmail, index) => {
                                    ...
                                    return (
                                        <React.Fragment key={processedEmail.id}>
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            <Text variant="body-default-xs">
                                                                ...
                                                                processedEmail.actionItems.length >
                                                                    0
                                            ...
                                            {index < getProcessedEmailsArray().length - 1 && (
                                                <Line color="neutral-alpha-weak" />
                                            )}
                                        </React.Fragment>
                                    );
